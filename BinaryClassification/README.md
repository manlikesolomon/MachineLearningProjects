In this project we trained and evaluated a binary classification model using tensorflow's sequential api to predict wether houses in a neighborhood are above a certain price.
